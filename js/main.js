...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const yearButtons = document.querySelectorAll('.slider-btn');
  
  // Select the current year text
  const currentYearText = document.querySelector('.social-impact-section h2');
  
  // Data for each year - update the description as needed
  const yearData = {
      2023: {
          education: "Key achievements, programs, and impact in education for 2023.",
          healthcare: "Key achievements, programs, and impact in healthcare for 2023.",
          entrepreneurship: "Key achievements, programs, and impact in entrepreneurship for 2023.",
          quality_of_life: "Key achievements, programs, and impact in quality of life for 2023.",
          gender: "Key achievements, programs, and impact in gender equality for 2023.",
          health: "Key achievements, programs, and impact in health for 2023."
      },
      2022: {
          education: "Key achievements, programs, and impact in education for 2022.",
          healthcare: "Key achievements, programs, and impact in healthcare for 2022.",
          entrepreneurship: "Key achievements, programs, and impact in entrepreneurship for 2022.",
          quality_of_life: "Key achievements, programs, and impact in quality of life for 2022.",
          gender: "Key achievements, programs, and impact in gender equality for 2022.",
          health: "Key achievements, programs, and impact in health for 2022."
      },
      2021: {
          education: "Key achievements, programs, and impact in education for 2021.",
          healthcare: "Key achievements, programs, and impact in healthcare for 2021.",
          entrepreneurship: "Key achievements, programs, and impact in entrepreneurship for 2021.",
          quality_of_life: "Key achievements, programs, and impact in quality of life for 2021.",
          gender: "Key achievements, programs, and impact in gender equality for 2021.",
          health: "Key achievements, programs, and impact in health for 2021."
      }
  };

  // Add event listeners for each year button
  yearButtons.forEach(button => {
      button.addEventListener('click', function() {
          const selectedYear = this.getAttribute('data-year'); // Get the year
          currentYearText.innerHTML = `The Social Impact Space ${selectedYear}`; // Update the header

          // Update the sector descriptions based on the selected year
          document.querySelector('.education p').textContent = yearData[selectedYear].education;
          document.querySelector('.healthcare p').textContent = yearData[selectedYear].healthcare;
          document.querySelector('.entrepreneurship p').textContent = yearData[selectedYear].entrepreneurship;
          document.querySelector('.quality-of-life p').textContent = yearData[selectedYear].quality_of_life;
          document.querySelector('.gender p').textContent = yearData[selectedYear].gender;
          document.querySelector('.health p').textContent = yearData[selectedYear].health;
      });
  });
});
...
function openModal(content) {
  // Optional: Extract a title (first line before a period)
  const firstSentence = content.split('.')[0] || 'Event Details';
  document.getElementById('modalTitle').innerText = firstSentence;

  const rows = content.split('. ').map((item) => item.trim()).filter(Boolean);

  const table = document.getElementById('modalContentTable');
